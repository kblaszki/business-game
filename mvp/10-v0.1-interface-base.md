...
Keep [`ScreenStack`](../src/screens/ScreenStack.hpp). Extract the navigation port screens actually need:
...
Keep `fixedUpdate(sf::Time)` (not v0.1 `update(float)`). Tick length is [`FixedTimestep::tick`](../src/utils/FixedTimestep.hpp).
