...
related_docs:
  ...
  - ../sfml/index.md
  - ../../index.md
keywords: [game development, SFML, C++, from scratch, best practices, external, multithreading]
...
2. [Multithreading analysis](./multithreading.md) — when threads help, SFML/OS constraints, recommended defaults
3. [Bibliography](./bibliography.md) — primary sources and what each is good for

## How to use this for comparison

Treat [from-scratch.md](./from-scratch.md) and [multithreading.md](./multithreading.md) as a checklist:
